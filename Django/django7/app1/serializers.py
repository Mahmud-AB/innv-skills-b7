...
#serializers,modelserialzers,hyperlinkedserializers
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    # phone = serializers.CharField(max_length=15, allow_blank=True, required=True)
    # student = Otherserializer(many=True, read_only=True)
    user = UserSerializer()
